...
class VideoDataGenerator:
    ...
    def flow_from_directory(self,
        ...
        labels = lb.fit_transform([x.split("/")[0] for x in videos])
        return self.__generate_batch(batch_size, dir, videos, labels, subset, target_size)



if __name__ == "__main__":
    gen = VideoDataGenerator(input_shape=(10, 224, 224, 3), shuffle=True, validation_split=0.2, rescale=1./255)
    generator = gen.flow_from_directory("./training", batch_size=5, subset="validation")
